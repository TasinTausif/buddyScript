    ...
    return (
        <div className='_feed_inner_text_area _b_radious6 _padd_b24 _padd_t24 _padd_r24 _padd_l24 _mar_b16 mt-4'>
            <form onSubmit={handleSubmit}>
                ...
                {image && (
                    <div className='position-relative my-3 ms-5 d-inline-block' style={{ maxWidth: '120px' }}>
                        <img
                        ...
                        <button
                            type='button'
                            className='btn btn-sm btn-danger position-absolute top-0 end-0 p-0 d-flex align-items-center justify-content-center shadow-sm'
                            style={{
